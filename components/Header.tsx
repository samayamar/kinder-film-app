...
export default function Header({ showNewAnalysisLink }: Props) {
  return (
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex gap-3">
            ...
            {showNewAnalysisLink && (
              <Link href="/" className="text-indigo-600 hover:text-indigo-800 font-semibold text-sm px-3 py-2 border border-indigo-600 rounded hover:bg-indigo-50 transition">
                ➕ Neue Analyse
              </Link>
            )}
          </div>
