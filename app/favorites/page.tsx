    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      <header className="bg-white shadow">
        <div className="max-w-3xl mx-auto px-4 py-6">
          ...
          <h1 className="text-4xl font-bold text-indigo-600">📚 Gespeicherte Filmanalysen</h1>
        </div>
      </header>
      ...
      <div className="max-w-3xl mx-auto p-4 md:p-8">
        {analyses.length === 0 ? (
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Noch keine Filmanalysen gespeichert.</p>
            <Link href="/" className="text-indigo-600 hover:text-indigo-800 font-semibold">
              Jetzt Film analysieren
            </Link>
          </div>
        ) : (
